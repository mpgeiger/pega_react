...
import {Container, Dropdown, Header, Pagination, Segment, Table} from "semantic-ui-react";

import moment from "moment";
import _ from "lodash";
import {assignmentActions, caseActions, workQueueActions} from "../../store/actions";
...
function mapStateToProps(state) {
    ...
    return {
        ...
        workBaskets: state.oauth.userData?.workbaskets
            ? state.oauth.userData.workbaskets
            : [],
